...
- **Primary in Orchestrate** (deployability review of C4 L2/L3) and **Secondary in Generate** (CI/CD, IaC tasks).
- **Escalate** on shared triggers plus: destructive operations on shared infrastructure (production config, IAM, secrets), novel infrastructure choices, cost-blowout risk.
