# Feature: setup agents correctly in claude as part of the install process
...
## 🤖 Next Action
Ask Claude to analyze requirements for setup agents correctly in claude as part of the install process